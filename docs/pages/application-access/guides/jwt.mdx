...
You can inject JWT in any header using [headers passthrough](./connecting-apps.mdx#headers-passthrough)
configuration and `{{internal.jwt}}` template variable. For example:
