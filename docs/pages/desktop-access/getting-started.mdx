...
<Admonition type="note" title="Secure Cipher Suites">
  ...
  This step is only *neccessary* for Windows Server 2012 R2 as it does not support
  secure algorithms by default.
</Admonition>


In this step we'll create a new certificate template that uses
elliptic curve cryptography, and then configure our GPO
